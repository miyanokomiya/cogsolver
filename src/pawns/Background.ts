...
export class Background extends Phaser.GameObjects.Container {
  constructor(scene: Phaser.Scene) {
    ...
    const gear2_1 = new Gear(scene, "p-2").setAlpha(0.5);
    ...
    const gear3_1 = new Gear(scene, "p-3").setAlpha(0.5);
    ...
    const gear2_4 = new Gear(scene, "p-2").setAlpha(0.5);
    ...
    const gear4_1 = new Gear(scene, "p-4").setAlpha(0.5);
...
export class Background2 extends Phaser.GameObjects.Container {
  constructor(scene: Phaser.Scene) {
    ...
    const gear2_5 = new Gear(scene, "p-2").setAlpha(0.5);
